...
local Library = Update:Window("Nano Hub","",Enum.KeyCode.RightControl);
...
H:AddLabel("Code By Nano")

H:AddLabel("Nano Hub Discord")
H:AddLabel("https://discord.com/invite/9N6b65vxss")
H:AddLabel("Discord .thuaz")
 

H:AddButton("🌟WELCOME NANO HUB🌟",function()
setclipboard("")
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16181252327";
      Title = "Nano Hub", 
      Text = "Copied";
})
end)
